...
int _setup_assoc_list(void) {
    ...
    assoc_mgr_user_list = list_create(slurmdb_destroy_user_rec);
    assoc_mgr_qos_list = list_create(slurmdb_destroy_qos_rec);
    assoc_mgr_tres_list = list_create(slurmdb_destroy_tres_rec);
