...
static inline void pass(const char *fmt, ...) {
    va_list ap;
...
static inline void xpass(const char *fmt, ...) {
    va_list ap;
...
static inline void xfail(const char *fmt, ...) {
    va_list ap;
...
static inline void untested(const char *fmt, ...) {
    va_list ap;
...
static inline void unresolved(const char *fmt, ...) {
    va_list ap;
...
static inline void note(const char *fmt, ...) {
    va_list ap;
...
static inline void totals(void) {
    printf("\nTotals:\n");
    printf("\t#passed:\t\t%d\n", passed);
