 ...
 */
stepd_step_rec_t *mgr_launch_tasks_setup(launch_tasks_request_msg_t *msg, slurm_addr_t *client, slurm_addr_t *self,
                                         uint16_t protocol_version);

/*
 * Initialize a stepd_step_rec_t structure for a batch job
 */
stepd_step_rec_t *mgr_launch_batch_job_setup(batch_job_launch_msg_t *msg, slurm_addr_t *client);
