...
void sort_job_list(List job_list) {
    ...
    for (i = (strlen(params.sort) - 1); i >= 0; i--) {
        ...
        else if (params.sort[i] == 'c');    /* sort_job_by_min_cpus_per_node */
        ...
        else if (params.sort[i] == 'f');    /* sort_job_by_featuers */
        else if (params.sort[i] == 'g')
            list_sort(job_list, _sort_job_by_group_name);
        else if (params.sort[i] == 'G')
            list_sort(job_list, _sort_job_by_group_id);
        else if (params.sort[i] == 'h');    /* sort_job_by_over_subscribe, not supported */
        ...
        else if (params.sort[i] == 'n');    /* sort_job_by_nodes_requested */
        else if (params.sort[i] == 'N')
            list_sort(job_list, _sort_job_by_node_list);
        else if (params.sort[i] == 'O');    /* sort_job_by_contiguous */
