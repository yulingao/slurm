...
enum {
    TAB_CLICKED, ROW_LEFT_CLICKED, ROW_CLICKED, FULL_CLICKED, POPUP_CLICKED
};

enum {
    ERROR_VIEW, INFO_VIEW
};

enum {
    STATUS_ADMIN_MODE, STATUS_REFRESH, STATUS_ADMIN_EDIT
};

enum {
    DISPLAY_NAME, DISPLAY_VALUE, DISPLAY_FONT
};

enum {
    EDIT_NONE, EDIT_ARRAY, EDIT_MODEL, EDIT_TEXTBOX, EDIT_COLOR
};
...
struct display_data {
    ...
    void (*admin_edit)(GtkCellRendererText *cell, const char *path_string, const char *new_text, gpointer data);

    void (*get_info)(GtkTable *table, display_data_t *display_data);

    void (*specific)(popup_info_t *popup_win);

    void (*set_menu)(void *arg, void *arg2, GtkTreePath *path, int type);
...
extern void change_grid_color(List button_list, int start, int end, int color_inx, bool change_unused,
...
extern void admin_edit_accnt(GtkCellRendererText *cell, const char *path_string, const char *new_text, gpointer data);
...
extern void set_menus_submit(void *arg, void *arg2, GtkTreePath *path, int type);
...
extern void set_page_opts(int tab, display_data_t *display_data, int count, char *initial_opts);

extern void free_switch_nodes_maps(switch_record_bitmaps_t *g_switch_nodes_maps);
...
extern gboolean
row_expander(GtkTreeView *tree_view, gboolean arg1, gboolean arg2, const signal_params_t *signal_params);

extern gboolean
row_expand(GtkTreeView *tree_view, GtkTreeIter *iter, GtkTreePath *path, const signal_params_t *signal_params);
...
extern gboolean focus_in(GtkTreeView *tree_view, GdkEventButton *event, const signal_params_t *signal_params);
...
extern void
add_display_treestore_line(int update, GtkTreeStore *treestore, GtkTreeIter *iter, const char *name, const char *value);
...
select_admin_common(GtkTreeModel *model, GtkTreeIter *iter, display_data_t *display_data, GtkTreeView *treeview,
                    uint32_t node_col,
                    void (*process_each)(GtkTreeModel *model, GtkTreePath *path, GtkTreeIter *iter, gpointer userdata));
