...
static display_data_t display_data_submit[] = {{G_TYPE_INT,    SORTID_POS,       NULL,        false, -1},
...
static display_data_t options_data_submit[] = {{G_TYPE_STRING, JOB_PAGE,    "Jobs",       true,  -1},
...
extern void
row_clicked_submit(GtkTreeView *tree_view, GtkTreePath *path, GtkTreeViewColumn *column, gpointer user_data) {
