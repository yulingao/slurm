...
int main(int argc, char **argv) {
    ...
    PMI2_Info_GetJobAttr("mpi_reserved_ports", val, PMI2_MAX_ATTRVALUE, &flag);
    ...
    PMI2_Info_GetJobAttr(buf, val, PMI2_MAX_ATTRVALUE, &flag);
    sprintf(key, buf);
    PMI2_KVS_Put(key, val);
    ...
    for (i = 0; i < size; i++) {
        ...
        PMI2_KVS_Get(jobid, PMI2_ID_NULL, key, val, sizeof(val), &len);
