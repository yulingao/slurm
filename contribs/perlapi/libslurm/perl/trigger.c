 ...
 */
int trigger_info_to_hv(trigger_info_t *trigger_info, HV *hv) {
 ...
 */
int hv_to_trigger_info(HV *hv, trigger_info_t *trigger_info) {
 ...
 */
int trigger_info_msg_to_hv(trigger_info_msg_t *trigger_info_msg, HV *hv) {
    int i;
    HV *hv_info;
    AV *av;
