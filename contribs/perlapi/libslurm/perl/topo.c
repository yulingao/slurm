 ...
 */
int topo_info_to_hv(topo_info_t *topo_info, HV *hv) {
 ...
 */
int hv_to_topo_info(HV *hv, topo_info_t *topo_info) {
 ...
 */
int topo_info_response_msg_to_hv(topo_info_response_msg_t *topo_info_msg, HV *hv) {
    int i;
    HV *hv_info;
    AV *av;
 ...
 */
int hv_to_topo_info_response_msg(HV *hv, topo_info_response_msg_t *topo_info_msg) {
    SV **svp;
    AV *av;
    int i, n;
