 ...
 */
int job_step_info_to_hv(job_step_info_t *step_info, HV *hv) {
    int j;
    AV *av;
 ...
 */
int hv_to_job_step_info(HV *hv, job_step_info_t *step_info) {
    SV **svp;
    AV *av;
    int i, n;
 ...
 */
int job_step_info_response_msg_to_hv(job_step_info_response_msg_t *job_step_info_msg, HV *hv) {
    int i;
    AV *av;
    HV *hv_info;
    ...
    for (i = 0; i < job_step_info_msg->job_step_count; i++) {
        hv_info = newHV();
        if (job_step_info_to_hv(job_step_info_msg->job_steps + i, hv_info) < 0) {
 ...
 */
int hv_to_job_step_info_response_msg(HV *hv, job_step_info_response_msg_t *step_info_msg) {
    int i, n;
    SV **svp;
    AV *av;
 ...
 */
int slurm_step_layout_to_hv(slurm_step_layout_t *step_layout, HV *hv) {
    AV *av, *av2;
    int i, j;
...
int job_step_pids_to_hv(job_step_pids_t *pids, HV *hv) {
    int i;
    AV *av;
...
int job_step_pids_response_msg_to_hv(job_step_pids_response_msg_t *pids_msg, HV *hv) {
    int i = 0;
    ListIterator itr;
    AV *av;
    HV *hv_pids;
 ...
 */
int job_step_stat_to_hv(job_step_stat_t *stat, HV *hv) {
    HV *hv_pids;
 ...
 */
int job_step_stat_response_msg_to_hv(job_step_stat_response_msg_t *stat_msg, HV *hv) {
    int i = 0;
    ListIterator itr;
