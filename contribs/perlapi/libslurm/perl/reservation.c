 ...
 */
int reserve_info_to_hv(reserve_info_t *reserve_info, HV *hv) {
    ...
    if (reserve_info->node_inx) {
        ...
        for (j = 0;; j += 2) {
            ...
            av_store(av, j + 1, newSVuv(reserve_info->node_inx[j + 1]));
        }
 ...
 */
int hv_to_reserve_info(HV *hv, reserve_info_t *resv_info) {
    SV **svp;
    AV *av;
    int i, n;
 ...
 */
int reserve_info_msg_to_hv(reserve_info_msg_t *reserve_info_msg, HV *hv) {
    int i;
    HV *hv_info;
    AV *av;
    ...
    for (i = 0; i < reserve_info_msg->record_count; i++) {
        hv_info = newHV();
        if (reserve_info_to_hv(reserve_info_msg->reservation_array + i, hv_info) < 0) {
 ...
 */
int hv_to_reserve_info_msg(HV *hv, reserve_info_msg_t *resv_info_msg) {
    SV **svp;
    AV *av;
    int i, n;
 ...
 */
int hv_to_update_reservation_msg(HV *hv, resv_desc_msg_t *resv_msg) {
 ...
 */
int hv_to_delete_reservation_msg(HV *hv, reservation_name_msg_t *resv_name) {
    resv_name->name = NULL;
