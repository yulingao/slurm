 ...
 */
int partition_info_to_hv(partition_info_t *part_info, HV *hv) {
 ...
 */
int hv_to_partition_info(HV *hv, partition_info_t *part_info) {
    SV **svp;
    AV *av;
    int i, n;
 ...
 */
int partition_info_msg_to_hv(partition_info_msg_t *part_info_msg, HV *hv) {
    int i;
    HV *hv_info;
    AV *av;
    ...
    for (i = 0; i < part_info_msg->record_count; i++) {
        hv_info = newHV();
        if (partition_info_to_hv(part_info_msg->partition_array + i, hv_info) < 0) {
 ...
 */
int hv_to_partition_info_msg(HV *hv, partition_info_msg_t *part_info_msg) {
    SV **svp;
    AV *av;
    int i, n;
 ...
 */
int hv_to_update_part_msg(HV *hv, update_part_msg_t *part_msg) {
 ...
 */
int hv_to_delete_part_msg(HV *hv, delete_part_msg_t *delete_msg) {
